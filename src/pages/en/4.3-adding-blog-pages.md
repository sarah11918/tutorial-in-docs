...
pubDate: 2022-07-08
tags: ["learning Astro", "successes", "blogging"]
---
...
pubDate: 2022-07-15
tags: ["learning Astro", "setbacks", "community"]
---
...
4. Check your browser preview for each of your six pages (3 Astro pages and 3 Markdown posts). If you look up at the browser tab itself, or inspect the `<title>` property in dev tools, what text is displayed for each page?
