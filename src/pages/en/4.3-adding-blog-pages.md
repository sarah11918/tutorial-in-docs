...
You might have noticed that when you preview any of your `.astro` pages (Home, About, Blog), your browser tab displays the page title. (See section 3.3 Layouts if you need to remember how we passed an Astro page's title to its layout.)
