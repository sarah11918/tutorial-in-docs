...
1. Copy the following code into the component script of `src/pages/blog.astro`
```astro
---
...
```
### Global Styles
You have seen that the Astro `<style>` tag is **scoped by default**, and only affects the styles in its own file. But, you will probably want some styles defined globally, throughout your entire project. 
